    ...
    <div style={{ maxWidth: 640, margin: "0 auto", padding: "1.5rem 1rem" }}>
      ...
      <Section title={isEN ? "How it works" : "Hvernig það virkar"}>
        {[
          ...
          isEN ? ["3. Follow-up questions", "The system identifies categories scoring below 3.5 (limiting) or above 4.5 (strong) — up to 4 in each direction. Each follow-up section shows the participant the 2–3 specific questions they rated lowest or highest, with their scores, so they can see exactly why this area was selected. They then select impact statements and can add their own reflections under “Other”."] : ["3. Framhaldsspurningar", "Kerfið greinir flokka undir 3.5 (takmarkandi) eða yfir 4.5 (sterkir) — allt að 4 í hvora átt. Í hverri framhaldsspurningahlið sér þátttakandinn 2–3 þær spurningar sem hann gaf lægst eða hæst stig, ásamt einkunninni, þannig að hann sér nákvæmlega hvers vegna þessi flokkur var valinn. Þátttakandinn velur síðan áhrifasetningar og getur bætt við eigin ígrundun undir „Annað“."],
          isEN ? ["4. Coach reports", "Two emails are sent to the coach: an initial score summary after the questionnaire, and a full Flow-Based Performance Coach Report with AI analysis as an HTML attachment after the follow-up is complete. A participant profile is also attached so the coach can reference both during the conversation."] : ["4. Þjálfunaskrárslur", "Tveir tölvupóstar berast þjálfaranum: upphafleg stigasamantekt eftir spurningalistann, og full Flow-Based skrársla með AI-greiningu sem HTML viðhengi eftir að framhaldsspurningunum er lokið. Þáttakaprófíll er einnig sendur sem viðhengi — eintak af því sem þátttakandinn sér — þannig að þjálfarinn getur vísað í bæðar skrárslur í samtali."],
        ].map(([title, text], i) => (
      ...
      <Section title={isEN ? "About the follow-up module" : "Um framhaldsmódúlinn"}>
        <P>{isEN
          ? "The follow-up module is the core innovation of this tool. Rather than leaving participants with a set of abstract scores, it does two things: first, it shows participants the specific questions they rated lowest or highest in each selected category — with their actual scores — so the connection between their responses and the follow-up is immediately clear. Second, it asks them to reflect on how those scores show up in their actual experience, both personally and at work."
          : "Framhaldsmódúlinn er kjarnaframlægi þessa tóls. Í stað þess að skilja þátttakendur eftir með óhlutbundin stig, gerir hann tvennt: í fyrsta lagi sýnir hann þátttakendum þær spurningar sem þeir gáfu lægst eða hæst stig í hverjum völdum flokki — ásamt raunverulegum stigum — þannig að tengingin milli svara þeirra og framhaldsspurninganna er strax skýr. Í öðru lagi biður hann þá um að ígrunda hvernig þessi stig birtast í raunverulegri reynd þeirra, bæði persónulega og í vinnu."
        }</P>
        <P>{isEN
          ? "Impact statements are predefined based on research and practice. Participants select all that feel relevant — there are no right or wrong answers. They are always invited to add their own words under “Other”. These personal additions are often the most valuable material for the coaching conversation, as they move beyond recognition into genuine reflection."
          : "Áhrifasetningarnar eru fyrirframskilgreindar byggt á rannsóknum og reynslu. Þátttakendur velja allt sem þykir við eiga — engin svör eru rétt eða röng. Þeim er alltaf boðið að bæta við eigin orðum undir „Annað“. Þessar persónulegu viðbætur eru oft gagnlegasta efnið í þjálfunarsamtalinu, þar sem þær fara lengra en viðurkenning yfir í raunverulega ígrundun."
        }</P>
        <InfoBox>{isEN
          ? "Note on follow-up selection: Follow-up questions are triggered for categories scoring below 3.5 (up to 4) and above 4.5 (up to 4). Participants with scores mostly in the moderate range may not see follow-up questions — this is by design. Moderate scores suggest no strong constraint or strength worth exploring in depth. In those cases, the coach report highlights the two lowest-scoring categories as areas worth exploring in conversation."
        ...
        {[
          ...
          },
          {
            ...
            qs: [
              ...
              { label: isEN ? "Deepen" : "Dýpkaðu", q: isEN ? '"What tends to trigger that — and what does it feel like when it is happening?"' : '"Hvað veldur þessu venjulega — og hvernig líður þér þegar þetta er að gerast?"', sub: isEN ? "Move from recognition to lived experience." : "Farðu frá viðurkennningu yfir í lifaða reynslu." },
          ...
          },
          {
            ...
            qs: [
              ...
              { label: isEN ? "Protect" : "Verndaðu", q: isEN ? '"What would need to stay in place to make sure this strength does not get eroded by other pressures?"' : '"Hvað þarf að vera til staðar til að tryggja að þessi styrkleiki veikist ekki vegna annars þrýstings?"', sub: null },
            ]
          },
          {
            num: 4,
